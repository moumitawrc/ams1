...
+ function(a) {
	...
	function b(b) {
		return this.each(function() {
			var d = a(this),
				e = d.data("bs.toggle2"),
				f = "object" == typeof b && b;
			e || d.data("bs.toggle2", e = new c(this, f)), "string" == typeof b && e[b] && e[b]()
		})
	}
	var c = function(b, c) {
	...
	c.VERSION = "2.2.0", c.DEFAULTS = {
		...
		var b = "large" === this.options.size ? "btn-lg" : "small" === this.options.size ? "btn-sm" : "mini" === this.options.size ? "btn-xs" : "",
			...
			g = a('<div class="toggle2 btn" data-toggle="toggle2">').addClass(this.$element.prop("checked") ? this._onstyle : this._offstyle + " off").addClass(b).addClass(this.options.style);
		...
		this.$element.off("change.bs.toggle2"), b || this.$element.change(), this.$element.on("change.bs.toggle2", a.proxy(function() {
			this.update()
		}, this))
	}, c.prototype.destroy = function() {
		this.$element.off("change.bs.toggle2"), this.$toggleGroup.remove(), this.$element.removeData("bs.toggle2"), this.$element.unwrap()
	};
	...
	a.fn.bootstrapToggle = b, a.fn.bootstrapToggle.Constructor = c, a.fn.toggle.noConflict = function() {
		...
		a("input[type=checkbox][data-toggle^=toggle2]").bootstrapToggle()
